# Generated by Powerlevel10k configuration wizard on 2021-08-18 at 07:52 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='\U1F914'
  ...
  function prompt_customemoji() {
    p10k segment -f 208 -i '😼' -t 'meow'
  }
